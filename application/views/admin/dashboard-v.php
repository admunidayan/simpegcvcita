          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown" style="margin-left: 7px">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="<?php echo base_url('index.php/admin/Export_excel') ?>"><i class="material-icons">assignment_ind</i>Laporan Data Pegawai</a>
                  <a class="dropdown-item" href="<?php echo base_url('index.php/admin/Export_honorer') ?>"><i class="material-icons">assignment_ind</i>Laporan Data Honorer</a>
                  ...
                  <a class="dropdown-item" href="<?php echo base_url('index.php/admin/Export_golongan') ?>"><i class="material-icons">select_all</i>Laporan Pegawai Per Golongan</a>
