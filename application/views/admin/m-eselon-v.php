<div style="margin-top: 14px; background-color: white;padding: 30px">
	...
	<div class="media-body">
		...
		<div class="media-right">
			<button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#addmastereselon"><i class="material-icons">note_add</i> Tambah Data </button>
		</div>
	</div>
	<hr/>
			<table class="table">
